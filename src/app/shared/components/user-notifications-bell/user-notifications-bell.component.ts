...
import { UserNotificationDetailModalComponent } from '../user-notification-detail-modal/user-notification-detail-modal.component';
...
@Component({
  ...
  template: `
    <div class="notif-wrap">
      ...
      <!-- Detail Modal (replaces in-popover detail view) -->
      <app-user-notification-detail-modal
